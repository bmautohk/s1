          ...
          <TD vAlign=top bgColor=#eefafc>
            ...
            <table width="180" border="0" cellspacing="10">
              <tr>
				...
				Products ID: 
				    <input name="sprod_id" type="text" id="sprod_id" value="<? echo $sprod_id;?>">
                ...
                <? 
				 ...
				 if (isset($_POST['sprod_id']) and $_POST['sprod_id']!='' and isset($_POST['search_sale']))
				 {
				 $sprod_id = $_POST['sprod_id'];
				 getsold_list($sprod_id);
                ...
                <br>
				 ...
				 getsold_list_date($date_start,$date_end,$sprod_top,$sprod_select);
				 //$print_link = "<a href=\"print_report.php?date_start=&date_end=&mod=$mod&sale_or=$sale_or&sale_as=$sale_as\" onClick=\"NewWindow(this.href,'mywin','800','500','no','center');return false\" onFocus=\"this.blur()\">Preview Report</a>";
				 }
