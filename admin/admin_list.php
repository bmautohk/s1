...
<table border="0" width="500" id="table18" cellspacing="0" cellpadding="0">
	<tr>
...
<i><b><font size="2"><? echo $domain; ?></font></a></b></i></td>
		...
		<a href="http://www.superior-autoparts.com/order_main_delete.php">Delete Record</a><br>
		<a href="../logs/index.php">
		View Access Log</a></font></b></i><br>
...
<table border="0" width="100%" id="table1">
	<tr>
		<td width="66%" valign="top" height="0">
	<font size="1" face="Tahoma">
<table border="1" width="84%" id="table14">
	<tr>
	...
	<font size="1" face="Tahoma">
		...
		<form method="POST" action="index.php?page=admin&subpage=add" onsubmit="return FrontPage_Form1_Validator(add_user)" language="JavaScript" name="add_user">
...
$i = 0;
    ...
    echo "<option value=\"HK\">HK</option>";
?>
				...
				<tr valign="top">
					...
					<td><font size="1" face="Tahoma">
			<select style="font-size: 8pt; font-family: Tahoma" name="redirect" id="redirect">
			  <option value="http://www.superior-autoparts.com/index.php">Website</option>
			  <option value="http://www.superior-autoparts.com/main.php ">Partner</option>
			  </select>
					</font></td>
				</tr>
				<tr>
	...
	<tr>
		<td width="33%" valign="top" height="0">
		<form method="POST" action="index.php?page=<?=$page?>&subpage=edit" onsubmit="return mod_user_Validator(mod_user)" language="JavaScript" name="mod_user">
...
?>
	...
	<tr>
		<td width="33%" valign="top" height="0">
		<form method="POST" action="index.php?page=<?=$page?>&subpage=edit">
...
echo "<tr>";
echo "<td>";
echo "<table border=\"1\" width=\"600\" id=\"table5\">";
echo "<tr>";
