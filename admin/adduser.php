...
if ($pass_len == "no")
{
	echo "<p>You must use a password between $min_pass and $max_pass characters in length, please <a href=\"javascript:history.go(-1)\">Go Back </a>and try again.</p>";
	exit;
}
...
<link rel="stylesheey" type="text/css" href="../style.css">
