...
<body>
	...
	$word_email = getsale_prod_email($sale_ref);
...
//$mail->AddAddress("amen_htm@hotmail.com",$m_first); 
//$mail->AddAddress("amen_htm@centralgolf.com.hk");               // optional name
...
debt_email_sent='1' where debt_ref= '".$sale_ref."'";
