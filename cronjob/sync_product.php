...
$pm_product_sql = "select no_jp, made, model, model_no, year, item_group, material, product_desc_jp, pcs, colour, colour_no, supplier, kaito from product_master";

$products = array();

/*
// Retrieve product from pm
...
$result = mysql_query($pm_product_sql, $db_pm) or die (mysql_error()."<br />Couldn't execute query: $sql");
...
mysql_select_db($db_name_pmkaito, $db_pmkaito);
mysql_query("SET NAMES 'ujis'", $db_pmkaito);
mysql_query("SET CHARACTER_SET_CLIENT=ujis", $db_pmkaito);
mysql_query("SET CHARACTER_SET_RESULTS=ujis", $db_pmkaito);

$result = mysql_query($pm_product_sql, $db_pmkaito) or die (mysql_error()."<br />Couldn't execute query: $sql");
