...
//return 
	...
	echo "<tr align=\"right\" valign=\"top\"> <td>".$sale_date."</td><td>".$sale_edit."<br> $sale_yahoo_id (".$sale_dat .")</td><td >".$sale_group."&nbsp;</td><td>".$debt_data."&nbsp;</td><td>".$bal_data."</td><td>".$return_data."</td><td $ship_bg >".$ship_data."</td></tr>\n";
	}
	//end loop
	echo "</table>";
...
// shipping 
	...
	echo "<tr valign=\"top\" align=\"right\"> <td>".$sale_date."</td><td>".$sale_ref."<br>(".$sale_dat .")</td><td width='120'>".number_format($sale_total)."&nbsp;</td><td>".number_format($sub_total)."&nbsp;</td><td>".number_format($sale_discount)."&nbsp;</td><td>".number_format($sale_ship_fee)."&nbsp;</td><td>".$sale_tax."&nbsp;</td><td width='120'>".$bal_data."</td><td width='120'>".$return_data."&nbsp;</td></tr>\n";
...
echo "</table><br><br>";
	...
	echo "<tr align=\"right\" valign=\"top\"><td >Order No.</td><td >Payment Date</td><td >Add Shipping No.</td>\n";
...
*/		
	...
	echo "<tr align=\"right\" valign=\"top\"> <td><a href='order_edit.php?sale_ref=$bal_ref'>".$bal_ref."</a></td><td>".$bal_dat."</td><td><a href='shipping.php?sale_ref=$bal_ref'>".$bal_ref."</a></td></tr>\n";
	}
	//end loop
	echo "</table>";
	}
...
//---------------------------------------------------------------
	...
	function ship_report_2($date_start,$date_end)
	{
	$db=connectDatabase();
	mysql_select_db("SUPERIOR_AUTOPARTS",$db);
	...
	echo "<tr align=\"right\" valign=\"top\"><td >Order No.</td><td >Group</td><td >Client Name</td><td >Payment Date</td><td >Add Shipping No.</td><td >Out Of Stock</td>\n";
	...
	echo "<tr align=\"right\" valign=\"top\"> <td><a href='order_edit.php?sale_ref=$bal_ref'>".$bal_ref."</a></td><td>&nbsp;".$sale_group."</td><td>&nbsp;".$sale_name."</td><td>".$bal_dat."</td><td><a href='shipping.php?sale_ref=$bal_ref'>".$bal_ref."</a></td><td >Y</td></tr>\n";
	}
	//end loop
	echo "</table>";
	}
...
//-------------------------------------------------------------------------------	
	...
	function email_report($date_start,$date_end)
	{
	$db=connectDatabase();
	mysql_select_db("SUPERIOR_AUTOPARTS",$db);
	$result = mysql_query("SELECT * FROM ben_email where DATE(email_datetime) between '$date_start' and '$date_end' order by email_datetime desc"  ,$db) or die (mysql_error()."<br />Couldn't execute query: $query");
	
	$num_results=mysql_num_rows($result);
	//table echo 
	echo "<table width=\"350\" border=\"1\" cellspacing=\"0\" cellpadding=\"0\">";
	echo "<tr align=\"right\" valign=\"top\"><td >Order No.</td><td >Email Date</td><td >Detail</td>\n";
	...
	echo "<tr align=\"right\" valign=\"top\"> <td><a href='order_edit.php?sale_ref=$email_ref'>".$email_ref."</a></td><td>".$email_dat."</td><td ><a target='_blank' href='email_detail.php?email_no=$email_no'>Click</a></td></tr>\n";
	}
	//end loop
	echo "</table>";
	}
...
//-------------------------------------------------------------------------------	
	...
	function pay_report($date_start,$date_end)
	{
	$db=connectDatabase();
	mysql_select_db("SUPERIOR_AUTOPARTS",$db);
	$result = mysql_query("SELECT * FROM ben_bal where DATE(bal_dat) between '$date_start' and '$date_end' order by bal_dat desc"  ,$db) or die (mysql_error()."<br />Couldn't execute query: $query");
	
	$num_results=mysql_num_rows($result);
	//table echo 
	echo "<table width=\"350\" border=\"1\" cellspacing=\"0\" cellpadding=\"0\">";
	echo "<tr align=\"right\" valign=\"top\"><td >Order No.</td><td >Payment Date</td><td >Detail</td>\n";
	...
	echo "<tr align=\"right\" valign=\"top\"> <td><a href='order_edit.php?sale_ref=$bal_ref'>".$bal_ref."</a></td><td>".$bal_dat."</td><td ><a target='_blank' href='balance.php?sale_ref=$bal_ref'>Click</a></td></tr>\n";
	}
	//end loop
	echo "</table>";
	}
//--------------------------------------------------------------------------	
	...
	function sent_report($date_start,$date_end)
	{
	$db=connectDatabase();
	mysql_select_db("SUPERIOR_AUTOPARTS",$db);
	$result = mysql_query("SELECT * FROM ben_check where DATE(check_date) between '$date_start' and '$date_end' order by check_date desc"  ,$db) or die (mysql_error()."<br />Couldn't execute query: $query");
	
	$num_results=mysql_num_rows($result);
	//table echo 
	echo "<table width=\"450\" border=\"1\" cellspacing=\"0\" cellpadding=\"0\">";
	echo "<tr align=\"right\" valign=\"top\"><td >Order No.</td><td >Tracking No.</td><td >Shipping Date</td><td >Detail</td>\n";
	...
	echo "<tr align=\"right\" valign=\"top\"> <td><a href='order_edit.php?sale_ref=$check_ref'>".$check_ref."</a></td><td>".$check_date."</td><td>".$check_shipping."</td><td ><a target='_blank' href='shipping.php?sale_ref=$check_ref'>Click</a></td></tr>\n";
	}
	//end loop
	echo "</table>";
	}
