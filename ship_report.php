        ...
        <TR>
          ...
          <tr valign="top">
            <td width="500">No tracking no. JP<br>              
              <? ship_report($group2, $user_name,'JP');; ?></td>
            <td width="500">No tracking no. HK <br>
              <? ship_report($group2, $user_name,'HK');; ?></td>
...
ship_report_2($today_10,$today,$group2, $user_name);
}
else
{ship_report_2($_GET['date_start'],$_GET['date_end'],$group2, $user_name);
} ?></td>
          </tr>
        </table>
</TD>
