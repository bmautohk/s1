...
function Body($invoice_no,$addr_id)
{
 ...
 $this->SetY(-2);
  ...
  $this->Cell(15,6,"",$border,0,'L',0);
	$this->Cell(75,6,$addr1,$border,0,'L',0);
	$this->Cell(50,6,$debt_row['debt_post_co'],$border,0,'L',0);
	$this->Cell(40,6,"",$border,1,'C',0);
 
$this->Cell(15,6,"",$border,0,'L',0);
	$this->Cell(75,6,$addr2,$border,0,'L',0);
	$this->Cell(100,6,$debt_row['debt_cust_address1'],$border,0,'L',0);
	$this->Cell(40,6,"",$border,1,'C',0);

	$this->Cell(15,6,"",$border,0,'L',0);
	$this->Cell(75,6,$addr3,$border,0,'L',0);
	$this->Cell(70,6,$debt_row['debt_cust_address2'],$border,0,'L',0);
	$this->Cell(50,6,"",$border,1,'C',0);
	 
	 $this->Cell(15,6,"",$border,0,'L',0);
 	$this->Cell(75,6,$addr_name,$border,0,'L',0);
	$this->Cell(80,6,$order_row['sale_name'],$border,0,'L',0);
	...
	$this->SetFont(KOZMIN, '',12);
 	$this->Cell(95,8,"",$border,0,'R',0);
	$this->Cell(100,8,$tel,$border,0,'L',0);
	$this->Cell(5,8,"",$border,1,'C',0);
	$this->Ln(20);
	$this->Cell(20,8,"",$border,0,'R',0);
	$this->Cell(100,8,"Prod. ID:".$sprod_id,$border,0,'L',0);
	$this->Cell(5,8,"",$border,1,'C',0);
	
	$this->Cell(20,8,"",$border,0,'R',0);
	$this->Cell(100,8,"Group:".$order_row['sale_group'],$border,0,'L',0);
	$this->Cell(5,8,"",$border,1,'C',0);
