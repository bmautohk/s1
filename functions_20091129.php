...
$tool_bar_array["invoice"]="<TABLE width=\"800\" cellPadding=10>
	...
	$tool_bar_array["order"]="<TABLE width=\"800\" cellPadding=10>
            <TBODY>
              <TR>
...
$tool_bar_array["product"]="<TABLE width=\"650\" cellPadding=5>
            <TBODY>
              <TR>
                <TD width=\"120\"><A class=standard 
                  href=\"index.php?page=product&subpage=add\">Add New Product </A></TD>
                <TD width=\"116\"><A class=standard 
                  href=\"index.php?page=product&subpage=list\">Products List </A></TD>
                <TD width=\"146\"><A class=standard 
                  href=\"index.php?page=product&subpage=search\">Search Product</A></TD>
                <TD width=\"216\"><A class=standard 
                  href=\"index.php?page=product&subpage=list_stock\">Products List (Out of Stock) </A></TD>
              </TR>
            </TBODY>
          </TABLE>";
...
$tool_bar_array["po"]="<TABLE width=\"\" cellPadding=10>
            <TBODY>
              <TR>
                <TD width=\"156\"><span class=\"cat cat\"><a href=\"index.php?page=po&subpage=add\" class=\"big\">PO add</a> </span></TD>
                <TD width=\"156\"><span class=\"cat cat\"><a href=\"index.php?page=po&subpage=ship_report\" class=\"big\">Shipping Report</a> </span></TD>
                <TD width=\"156\"><span class=\"cat cat\"><a href=\"index.php?page=po&subpage=show_item\" class=\"big\">Show Item</a> </span></TD>
								<TD width=\"156\"><span class=\"cat cat\"><a href=\"index.php?page=po&subpage=ship_list\" class=\"big\">Shipping Item List</a> </span></TD>
              </TR>
            </TBODY>
          </TABLE>";
...
$tool_bar_array["report"]="<TABLE width=\"\" cellPadding=10>
            <TBODY>
              <TR>
                <TD width=\"156\"><span class=\"cat cat\"><a href=\"index.php?page=report&subpage=inventory\" class=\"big\">Inventory Report</a> </span></TD>
              </TR>
            </TBODY>
          </TABLE>";
...
$tool_bar_array["stock"]="<TABLE width=\"\" cellPadding=10>
            <TBODY>
              <TR>
                <TD width=\"156\"><span class=\"cat cat\"><a href=\"index.php?page=stock&subpage=in_add\" class=\"big\">In Stock</a> </span></TD>
				<TD width=\"156\"><span class=\"cat cat\"><a href=\"index.php?page=stock&subpage=out_add\" class=\"big\">Out Stock</a> </span></TD>
              </TR>
            </TBODY>
          </TABLE>";
...
function getreport($date_start,$date_end,$sale_or,$sale_as,$mod, $username)
	{
	$bal_total = 0;
	$sale_total = 0;
	$return_total = 0;
