...
?>
            ...
            <table width="1200" height="24" border="0" cellpadding="0" cellspacing="0">
              <tr valign="middle">
...
mysql_select_db("autopart_db",$db);
    ...
    $sql_text = "SELECT * FROM ben_product_tt order by product_id DESC"; 
    ...
    echo "<a href=\"$PHP_SELF?page=$next_page\">Next</a> ";
                ...
                <form name="form1" method="post" action="prod_list_add.php">
                  <table width="1196" border="1" align="left" cellpadding="0" cellspacing="0">
                    <tr align="center" valign="top">
                      <td width="88" height="30"><div align="center">Made</div></td>
                      <td width="88"><div align="center">Model</div></td>
                      <td width="117"><div align="center">Model No</div></td>
                      <td width="121"><div align="center">NO</div></td>
					  <td width="115"><div align="center">NO.JP</div></td>
                      <td width="97">NO.US</td>
					  <td width="129">Item Description</td>
                      <td width="78">Stock HK<br></td>
                      <td width="71">Stock JP</td>
                      <td width="69">Stock US</td>
                      <td width="98">Stock CN </td>
                      <td width="99">Delete item </td>
                      </tr>
                    <tr valign="top">
                      <td height="25">&nbsp;</td>
                      <td>&nbsp;</td>
    ...
    getprod_list_t($prod_order,$page_start, $per_page);
