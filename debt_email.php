...
記口座へお振り込みいただきましたら、確認次第発送手配させていただきます。 <br>なお、商品に関する内容はオークション記載の通りです。<br>十分ご納得の上でのお取引をお願いします。<br><br>";
	...
	$email_text = $email_text . "落札商品：".$sprod_name."<br>"; //.$sprod_id."<br>";
	}
...
yahooかんたん決算も登録してありますので、ご利用になれます。


当方複数の商品を出品しており、多数の方とメールのやり取りをしておりますので、発送準備を円滑に行うため、お手数ですがメール確認後に、件名を変えずに, 商品送付先（郵便番号・住所・名前,�筺砲髻畔嵜�”にて折り返しご連絡ください。商品オークションID番号がない場合、発送の遅れ・トラブルの原因となります。必ず商品オークションID番号記載の上、返信をお願いいたします。
...
//$mail->Host     = "smtp.mail.goo.ne.jp"; // SMTP servers
//$mail->Username = "benben2000_2006";  // SMTP username
//$mail->Password = "344416"; // SMTP password
//$mail->Port1		="587";
...
echo "false";}
	...
	<form name="form1" method="POST" action="debt_email.php">
	 <? }else { ?>
