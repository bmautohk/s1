...
$self_link_photo = 'http://74.53.227.146/~autopart/pro_image/' ;

define("Self_link_photo", "http://74.53.227.146/~autopart/pro_image/");
...
function connectDatabase(){
	...
	$db = mysql_connect("74.53.227.146", "autopart_adm","11g09e9");
