...
function Body($invoice_no)
{
 ...
 $this->SetY(-3);
  ...
  if ($branchid=="A")  {
	...
	$this->Cell(145,8,iconv("UTF-8", "BIG5-HKSCS",$printShopName),$border,0,'C',0);
	$this->Cell(30,8,iconv("UTF-8", "BIG5-HKSCS",$rightLabel1),"TRL",1,'C',0);
	
	$this->Cell(30,8,iconv("UTF-8", "BIG5-HKSCS",""),$border,0,'C',0);
  $this->Cell(145,8,iconv("UTF-8", "BIG5-HKSCS",$printShopDetail),$border,0,'C',0);
  $this->Cell(30,8,iconv("UTF-8", "BIG5-HKSCS",$rightLabel2),"BRL",1,'C',0);
   ...
   $this->Cell(216,8,iconv("UTF-8", "BIG5-HKSCS",$printShopDetail),$border,1,'C',0);
	...
	$this->Cell(35,8,iconv("UTF-8", "BIG5-HKSCS",""),$border,0,'R',0);
if ($customer_tel=="888")
	$this->Cell(50,8,iconv("UTF-8", "BIG5-HKSCS","自取").$delivery_date,$border,1,'C',0);
	else
	$this->Cell(50,8,iconv("UTF-8", "BIG5-HKSCS","送貨").$delivery_date,$border,1,'C',0);
...
//	$this->Cell(22,6,iconv("UTF-8", "BIG5-HKSCS",$row2['manpower']),0,0,'C',0);
 ...
 $this->Cell(22,6,iconv("UTF-8", "BIG5-HKSCS",""),$border,1,'C',0);
	...
	$this->Cell(5,6,iconv("UTF-8", "BIG5-HKSCS",""),$border,0,'R',0);		
 	...
 	$this->Cell(25,6,iconv("UTF-8", "BIG5-HKSCS",number_format($creditcardtotal, 2, '.', ',')),$border,0,'R',0);
 	$this->Cell(5,6,iconv("UTF-8", "BIG5-HKSCS",""),$border,1,'R',0);}
	else
	{ $this->Cell(22,6,iconv("UTF-8", "BIG5-HKSCS",""),$border,1,'C',0);}

	$this->Cell(5,7,iconv("UTF-8", "BIG5-HKSCS",""),$border,0,'R',0);	
 	$this->Cell(140,7,iconv("UTF-8", "BIG5-HKSCS",""),$border,0,'R',0);
