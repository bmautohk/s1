...
#--------------------------------#
   ...
   //--------------------------------------end file submit
		...
		*/
		...
		$sql = "INSERT INTO ben_product SET product_id = '$product_id', product_name = '$product_name',product_photo = '',product_dit = '$dit_name'
				,cat_id = '$cat_id',
			...
			$sql = "INSERT INTO ben_product SET product_id = '$product_id', product_name = '$product_name',product_photo = '$product_photo',product_dit = '$dit_name'
			 ...
			 echo "<input type=text name='product_stock_level' value='".@$product_stock_level."'>";
			  ?></td>
                      ...
                      <tr>
                        <td>Location</td>
                        <td><? 
			 echo "<input type=text name='product_location' value='".@$product_location."'>";
			  ?></td>
                      </tr>
                      <tr>
                        <td>&nbsp;</td>
