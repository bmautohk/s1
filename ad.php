...
function goToURL(obj) {
   ...
   top.location = "<? echo $_SERVER['PHP_SELF']."?pro_num="; ?>" + obj;
}
...
<TABLE height="100%" cellSpacing=0 cellPadding=0 width="100%" border=0>
  ...
  <TR>
    <TD vAlign=top bgColor=#eefafc colSpan=6 height="100%">
      <TABLE cellSpacing=0 cellPadding=0 width="100%">
        ...
        <TR>
          <TD vAlign=top bgColor=#eefafc>        <form action="table.php" method="post" enctype="multipart/form-data" name="form1">
  <table width="679" border="1">
    <tr>
      <td width="110">Main Photo Link </td>
      <td width="197"><input name="pro_main" type="text" id="pro_main"></td>
      <td width="83">Font Color </td>
      <td width="261"><input name="pro_color" type="text" id="pro_color"></td>
    </tr>
    <tr>
      <td>Nuber of Photo</td>
      <td><select name='pro_num' onChange="goToURL(this.options[this.selectedIndex].value)">
        <? for ($i=1;$i<95;$i++)
	{
    ...
    <tr>
      <td>Space</td>
      <td><input name="pro_space" type="text" id="pro_space2"></td>
      <td>Font Type </td>
  ...
  <table width="787" border="1">
    <tr>
      ...
      <td width="179">Browse</td>
      <td width="179">Link</td>
      <td width="154">Detail</td>
    </tr>
  <? for ($j=1;$j<$pro_num+1;$j++) {?>
    <tr>
      <td><?=$j;?></td>
      <td><input name="pro_name_<?=$j;?>" type="text" id="pro_name">&nbsp;</td>
      <td><input type="file" name="file_<?=$j;?>" onchange="pro_link_<?=$j;?>.value+=this.value" ></td>
      <td><input name="pro_link_<?=$j;?>" type="text" id="pro_link">
      &nbsp;</td>
      <td><input name="pro_detail_<?=$j;?>" type="text" id="pro_link">&nbsp;</td>
    </tr>
  <? } ?>
  </table>
  <br>
