...
function clearProductField(row) {
	...
	document.getElementById("wareHouse1_" + row).checked = false;
	document.getElementById("wareHouse2_" + row).checked = false;
	document.getElementById("wareHouse3_" + row).checked = false;
	document.getElementById("wareHouse4_" + row).checked = false;
}
