...
{$prod_n = $_GET['prod_n'];} else {$prod_n='';}
...
<TABLE height="100%" cellPadding=10 width="100%" border=0>
  ...
  <TR>
    <TD width="104%" height="100%" vAlign=top bgColor=#eefafc>  
        ...
        <br>
        <?
		if ($prod_id!='') getFind_prod_rmks($prod_id);?>
		</form>
