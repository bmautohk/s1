...
$this->SetFont(KOZMIN, '',12);
	...
	$this->Cell(23,9,"",$border,0,'R',0);
	$this->Cell(100,9,$debt_row['debt_cust_address1'],$border,0,'L',0);
	$this->Cell(40,9,"",$border,1,'C',0);

	$this->Cell(23,9,"",$border,0,'R',0);
	$this->Cell(67,9,$debt_row['debt_cust_address2'],$border,0,'L',0);
	$this->Cell(50,9,"Prod. ID:".$sprod_id,$border,1,'L',0);
	$this->Ln(8);
 	$this->Cell(23,9,"",$border,0,'R',0);
	$this->Cell(67,9,$order_row['sale_name'],$border,0,'L',0);
	$this->Cell(50,9,"Group:".$order_row['sale_group'],$border,1,'C',0);
...
$this->SetFont(KOZMIN, '',9);	 
 	$this->Cell(30,6,"",$border,0,'R',0);
	$this->Cell(100,6,$tel,$border,0,'L',0);
	$this->Cell(5,6,"",$border,1,'C',0);

	$this->ln(5);
	$this->SetFont(KOZMIN, '',12);	 
	$this->Cell(20,6,"",$border,0,'R',0);
	$this->Cell(100,6,$addr1,$border,0,'L',0);
	$this->Cell(5,6,"",$border,1,'C',0);
	
	 	$this->Cell(20,6,"",$border,0,'R',0);
	$this->Cell(100,6,$addr2,$border,0,'L',0);
	$this->Cell(5,6,"",$border,1,'C',0);
	
		$this->Cell(20,6,"",$border,0,'R',0);
	$this->Cell(100,6,$addr3,$border,0,'L',0);
	$this->Cell(5,6,"",$border,1,'C',0);
	
			$this->Cell(20,6,"",$border,0,'R',0);
	$this->Cell(100,6,"",$border,0,'L',0);
	$this->Cell(5,6,"",$border,1,'C',0);
	
		$this->Cell(20,6,"",$border,0,'R',0);
	$this->Cell(100,6,$addr_name,$border,0,'L',0);
	$this->Cell(5,6,"",$border,1,'C',0);
...
$pdf=new PDF('P','mm',array(190,100));
