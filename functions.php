            ...
            <TBODY>
              <TR>
                ...
                <TD width=\"273\"><span class=\"cat cat\"><a href=\"main.php\" class=\"big\">Main <br>
                  ...
                  product</a></span></TD>
				    <TD width=\"273\"><span class=\"cat cat\"><a href=\"index.php?page=order&subpage=upload_clickpost_csv\" class=\"big\">upload    <br>
                  clickPost</a></span></TD>
              </TR>
            </TBODY>
          </TABLE>";
...
$tool_bar_array["po"]="<TABLE width=\"\" cellPadding=10>
            <TBODY>
              <TR>
				...
				<TD><span class=\"cat cat\"><a href=\"index.php?page=po&subpage=show_item\" class=\"big\">出貨装櫃</a> </span></TD>
...
function getedit_list($sale_ref)
{
	...
	echo "<tr align=\"center\" valign=\"middle\">
		  ...
		  <td >33<a href=\"order_delete.php?sprod_no=$sprod_no&sale_ref=$sale_ref\">Delete</a></td>
 			</tr>";
      }
	echo "</table>"; 
