...
*/
	...
	foreach ($result as $row) {
		...
		$sheet->getCellByColumnAndRow($i++, $rowNo)->setValueExplicit(conv($row['debt_tel']),$type);  //B
			...
			->setCellValueByColumnAndRow($i++, $rowNo, conv($row['debt_cust_address1']))  //D
			->setCellValueByColumnAndRow($i++, $rowNo, conv($row['debt_cust_address2']))  //E
			->setCellValueByColumnAndRow($i++, $rowNo, conv($row['debt_cust_address3']))  //F
			->setCellValueByColumnAndRow($i++, $rowNo, conv($row['sale_name']))  //G
			->setCellValueByColumnAndRow($i++, $rowNo, conv($row['sale_name'])) //H
			->setCellValueByColumnAndRow($i++, $rowNo, conv($row['bal_ref']))   //I
			->setCellValueByColumnAndRow($i++, $rowNo,"")  //J
			...
			$sheet->setCellValueByColumnAndRow($i++, $rowNo, conv($row['sprod_id'])) //T
			->setCellValueByColumnAndRow($i++, $rowNo, conv($row['sprod_name']))  //U
