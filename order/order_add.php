  ...
  <? getgroup_select($_SESSION[user_name]);?>
      ...
      <table width="584" border="1" cellpadding="0" cellspacing="0">
        <tr bgcolor="#CCCCCC">
          ...
          <td width="82"><div align="center">Stock</div></td>
          </tr>
        <? for ($j=1;$j<=$prod_n;$j++) {?>
          
		<tr>
			<td><div align="center">
				<input name="sprod_id_<? echo $j?>" type="text" id="sprod_id_<? echo $j?>" onchange="findProduct(<?=$j ?>)">
				<input name="isfind" type="button" id="isfind" value="Find" onClick="openProdWin(<?=$j ?>)">
			</div></td>
			<td><div align="center">
